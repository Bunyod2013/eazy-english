...
import { View, Text, TextInput, ScrollView, KeyboardAvoidingView, Platform, TouchableOpacity, Animated, ActivityIndicator } from 'react-native';
        ...
        >
          {isLoading ? (
            ...
            <Text style={{
              fontSize: 17,
              fontWeight: '700',
              color: canContinue ? '#fff' : colors.text.tertiary,
            }}>
              Boshlaymiz!
            </Text>
          )}
