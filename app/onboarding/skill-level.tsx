    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.bg.secondary }}>
      ...
      <View style={{ paddingHorizontal: 24, paddingTop: 12, paddingBottom: 8 }}>
        <View style={{ height: 6, backgroundColor: isDark ? 'rgba(255,255,255,0.1)' : '#f0f0f0', borderRadius: 3 }}>
          <View style={{ width: '60%', height: '100%', backgroundColor: colors.green.primary, borderRadius: 3 }} />
        </View>
                ...
                <TouchableOpacity
                  ...
                  style={{
                    backgroundColor: isSelected
                      ? (isDark ? `${item.color}15` : item.bgColor)
                      : colors.bg.card,
                    borderRadius: 22,
                    padding: 20,
                    borderWidth: 2,
                ...
                >
                  <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <View style={{
                      ...
                      marginRight: 16,
                      borderWidth: 1,
                      borderColor: isDark ? `${item.color}30` : item.borderColor,
                    }}>
                    ...
                    <View style={{ flex: 1 }}>
                      ...
                      <Text style={{ fontSize: 13, color: item.color, fontWeight: '600', marginTop: 2 }}>
                        {item.sub}
                      </Text>
                    </View>
