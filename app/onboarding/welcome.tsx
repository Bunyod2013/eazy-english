...
import { LionIcon, TargetIcon, TrophyIcon, BookIcon } from '@/components/icons';
          ...
          {features.map((f, i) => (
            <Animated.View key={i} style={cardStyle([cardAnim1, cardAnim2, cardAnim3][i])}>
              <View style={{
                ...
                <View style={{ flex: 1 }}>
                  <Text style={{ fontSize: 17, fontWeight: '600', color: '#fff', letterSpacing: -0.3 }}>
                    {f.title}
                  </Text>
